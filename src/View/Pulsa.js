    ...
    return (
      <div className="body">
            ...
            <TextField style={{ minWidth:'100%', marginTop:'5%'}}
              ...
              <div className="value-content">
                <div className="box">
                    <h3>pulsa 15.000</h3>
                    <p>Rp 25.000</p>  
                    <Radio.Button value={15.000}>pilih</Radio.Button>
                </div>
                <div className="box">
                    <h3>pulsa 25.000</h3> 
                    <p>Rp 25.000</p> 
                ...
                <div className="box">
                    <h3>pulsa 30.000</h3> 
                    <p>Rp 30.000</p> 
                    <Radio.Button value={30.000}>pilih</Radio.Button> 
                </div>
                <div className="box">
                    <h3>pulsa 40.000</h3>
                    <p>Rp 40.000</p> 
                ...
                <div className="box">
                    <h3>75.000</h3>
                    <p>Rp 75.000</p>  
                    <Radio.Button value={75.000}>pilih</Radio.Button> 
                </div>
                <div className="box">
                    <h3>100.000</h3>
                    <p>Rp 100.000</p>  
          ...
          <Divider/>
            ...
            <br></br>
            <br></br>
            <h3 style={{textAlign:'center', color:'#17bad1'}}>Bebaskan Pilihan Beli Pulsa - Paket Internet mu di Anterin</h3>
            <br></br>
            <br></br>
            <br></br>
